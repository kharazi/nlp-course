...
\huge NLP Homework 2, Part 1 \\ % The assignment title
...
\includegraphics[scale=0.3]{wedit.png}
\centering

\textbf{Test:} There is an example in course slides to compute edit distance between intention and execution. here is my result of this example:

\includegraphics[scale=0.7]{testone.png}
\centering

\begin{flushleft}
The first matrix is D, Second matrix is back-track(T = Top, L = Left, D = Diag). Finally you can find the path of minimum edit distance:
